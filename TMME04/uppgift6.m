...
%% animiering
%t_scale=1; fig1=5; fig2=6;
%anim_y2_2014a (t_vek,theta,phi,F_Ah,F_Av,l1,l2,t_scale,fig1,fig2)
...
legend('phi')
subplot(1,3,3)
plot(t_vek,theta*180/pi - phi*180/pi)
legend('theta-phi')

% animering
%t_scale=3; fig1=5; fig2=6;
%anim_y2_2014b (t_vek,theta,phi,F_Ah,F_Av,a,t_scale,fig1,fig2)

kappa = (((ka1^2)/b) - ((kb2^2)/c))/( 1 + (m2/b*m1).*((kb2^2/c)-c));
